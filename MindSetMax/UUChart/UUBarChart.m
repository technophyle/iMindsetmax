...
-(void)setYLabels:(NSArray *)yLabels
{
    ...
    float level = (_yValueMax-_yValueMin) /_yLabelGap;
    CGFloat chartCavanHeight = self.frame.size.height - UULabelHeight*3;
    CGFloat levelHeight = chartCavanHeight /_yLabelGap;
    
    for (int i=0; i<=_yLabelGap; i++) {
...
- (void)setYLabelGap:(double)yLabelGap {
    _yLabelGap = yLabelGap;
}
-(void)strokeChart
{
